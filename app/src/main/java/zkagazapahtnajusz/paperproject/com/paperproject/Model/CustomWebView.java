...
public class CustomWebView extends WebView {
    ...
    //MovementVals
    int touchEventTime = 150, B_TileX, B_TileY, P_Tile, V_Width, V_Height;
    Rect BackRect, PointerRect;
    ...
    public void setCustomOnTapChangeListener(CustomOnTapChangeListener customOnTapChangeListener) {
        ...
        customGestureDetector.setCustomOnTapChangeListener(customOnTapChangeListener);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        //endregion
        mGestureDetector.onTouchEvent(event); //register event
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(isDebug){
            if(BackRect != null) {
                //region Back
                Log.e(TAG, "BackRect:" + BackRect.toString());
                dPaint.setColor(Color.BLACK);
                canvas.drawRect(BackRect, dPaint);
                //endregion
            }

            if(PointerRect != null) {
                //region Pointer
                Log.e(TAG, "PointerRect:" + PointerRect.toString());
                dPaint.setColor(Color.RED);
                canvas.drawRect(PointerRect, dPaint);
                //endregion
            }
        }
    }
...
class CustomGestureDetector  implements GestureDetector.OnGestureListener {
    ...
    private CustomWebView.CustomOnTapChangeListener customOnTapChangeListener;

    void setCustomOnTapChangeListener(CustomWebView.CustomOnTapChangeListener customOnTapChangeListener) {
        this.customOnTapChangeListener = customOnTapChangeListener;
    }

    @Override
    public boolean onSingleTapUp(MotionEvent e) {
        if(customOnTapChangeListener != null){customOnTapChangeListener.onTap();}
        return true;
    }
